...
constraint FkIdEncargadoPed foreign key(IdEncargado) references Trabajadores (IdTrabajador),
...
as 
begin
insert into PEDIDO(IdEncargado,ENCARGADO,DNIR,NOMBRER,CORREOR,TELEFONOR,DIRECCIONR,DISTRITOR,PROVINCIAR,DEPARTAMENTOR,DNID,NOMBRED,CORREOD,TELEFONOD,DIRECCIOND,DISTRITOD,PROVINCIAD,DEPARTAMENTOD,CODIGOPEDIDO,CANTIDADPAQUETE,CATEGORIAPAQUETE,DESCRIPCIONPAQUETE,IdLote) 
	values(@IDENCARGADO,@ENCARGADO,@DNIR,@NOMBRER,@CORREOR,@TELEFONOR,@DIRECCIONR,@DISTRITOR,@PROVINCIAR,@DEPARTAMENTOR,@DNID,@NOMBRED,@CORREOD,@TELEFONOD,@DIRECCIOND,@DISTRITOD,@PROVINCIAD,@DEPARTAMENTOD,@CODIGOPEDIDO,@CANTIDADPAQUETE,@CATEGORIAPAQUETE,@DESCRIPCIONPAQUETE,@IdLote)
end
GO
